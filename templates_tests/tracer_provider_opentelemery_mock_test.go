...
//go:generate minimock -i go.opentelemetry.io/otel/trace.TracerProvider -o ./templates_tests/tracer_provider_opentelemery_mock_test.go -n OpentelemetryTracerProviderMock
